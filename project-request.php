        ...
        <section class="form_container">
            ...
            <form action="">
                ...
                <div class="form_group">
                    ...
                    <input type="text" placeholder="Customer Name"><input type="text" placeholder="Organization Name">
                </div>
                <div class="form_group">
                    ...
                    <input type="text" placeholder="Project High-Level Objectives"><input type="text"
                        placeholder="Project Low-Level Objectives">
                </div>
                <div class="form_group">
