...
<body>
    <div>
        <nav>
            <div class="nav-logo">
                <img src="./image/lixir_logo.png" class="logo" alt="logo" width="70%" />
            </div>
            <div class="burger">
                <div class="line1"></div>
                <div class="line2"></div>
                ...
                <div class="row no-gutters ">
                    ...
                    <div class="col-md-10">
                        <div class="card-body">
                            ...
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Error nostrum
    ...
    <footer class="mt-5">
        <section class="footer_content mx-auto text-center">
            <section class="footer_content--one">
                <a href="about_us.php" class="">About Us</a>
                <a href="index.php" class="mx-5">
                    <img src="image/footer_logo.png" alt="" width="100px" height="100px" /></a>
                <a href="contact.php" class="">Contact Us</a>
            </section>
            <section class="footer_content--two pt-4">
